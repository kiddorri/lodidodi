    ...
    <div className="flex flex-col gap-8">
      <div className="rounded-2xl bg-champagne p-8 sm:p-12">
        ...
        <h1 className="mt-4 text-4xl font-extrabold leading-tight tracking-tight text-codium sm:text-5xl">
          Мусор уезжает — и исчезает из виду
        </h1>

        <p className="mt-4 max-w-2xl text-lg text-bistre">
          Один оператор на весь город, полигон 1975 года и «27,8%
          отсортировано» на бумаге — при реальной переработке 10–15%.
          Проверить, что на самом деле происходит с мусором после того, как
          машина отъехала от двора, сейчас невозможно.
        </p>
